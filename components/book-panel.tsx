...
export function BookPanel({ open, onClose }: BookPanelProps) {
  return (
    <Sheet open={open} onOpenChange={onClose}>
      <SheetContent 
        side="right" 
        className="w-full sm:w-[400px] p-0 bg-[#0f172a] text-white overflow-y-auto"
      >
        {/* Header */}
        <div className="sticky top-0 z-10 bg-[#0f172a] p-4">
          <Button 
            onClick={onClose}
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 p-4">
          <Button 
            variant="outline"
            className="h-12 bg-transparent border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white"
          >
            Summary
          </Button>
          <Button 
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4">
          <div className="bg-[#1a2436] rounded-lg p-4">
        ...
        <div className="p-4">
          ...
          <div className="bg-[#1a2436] rounded-lg p-6 text-center text-gray-400">
